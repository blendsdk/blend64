  ...
  describe('Basic Module Analysis', () => {
    it('should analyze single module without errors', () => {
      const program = factory.createProgram(
        ...
        [],
        [],
        [factory.createFunctionDeclaration('main', [], factory.createPrimitiveType('void'), [], false, false)]
      )
    ...
    it('should collect exported symbols correctly', () => {
      const exportedFunction = factory.createFunctionDeclaration('updatePlayer', [], factory.createPrimitiveType('void'), [], false, true)
      const program = factory.createProgram(
  ...
  describe('Import/Export Resolution', () => {
    it('should successfully resolve valid imports', () => {
      ...
      const exportingModule = factory.createProgram(
        ...
        [],
        [factory.createExportDeclaration(factory.createFunctionDeclaration('calculateScore', [], factory.createPrimitiveType('byte'), [], false, true))],
        [factory.createFunctionDeclaration('calculateScore', [], factory.createPrimitiveType('byte'), [], false, true)]
      )
    ...
    it('should detect missing exported symbols', () => {
      ...
      const exportingModule = factory.createProgram(
        ...
        [],
        [],
        [factory.createFunctionDeclaration('internalFunction', [], factory.createPrimitiveType('void'), [], false, false)]
      )
  ...
  describe('Circular Dependency Detection', () => {
    it('should detect simple circular dependencies', () => {
      const moduleA = factory.createProgram(
        ...
        [],
        [factory.createFunctionDeclaration('funcA', [], factory.createPrimitiveType('void'), [], true, false)]
      )
      ...
      const moduleB = factory.createProgram(
        ...
        [],
        [factory.createFunctionDeclaration('funcB', [], factory.createPrimitiveType('void'), [], true, false)]
      )
    ...
    it('should allow modules without circular dependencies', () => {
      const moduleA = factory.createProgram(
        ...
        [],
        [],
        [factory.createFunctionDeclaration('funcA', [], factory.createPrimitiveType('void'), [], false, true)]
      )
      ...
      const moduleB = factory.createProgram(
        ...
        [],
        [factory.createFunctionDeclaration('funcB', [], factory.createPrimitiveType('void'), [], false, true)]
      )
  ...
  describe('Export Validation', () => {
    it('should validate that exported symbols are declared', () => {
      const program = factory.createProgram(
        factory.createModuleDeclaration(factory.createQualifiedName(['Game', 'Main'])),
        [],
        [factory.createExportDeclaration(factory.createFunctionDeclaration('undeclaredFunction', [], factory.createPrimitiveType('void'), [], false, true))],
      ...
      expect(errors[0].message).toContain('Cannot export \'undeclaredFunction\' - symbol not declared')
    })

    it('should allow exporting declared symbols', () => {
      const declaredFunction = factory.createFunctionDeclaration('declaredFunction', [], factory.createPrimitiveType('void'), [], false, true)
      const program = factory.createProgram(
        factory.createModuleDeclaration(factory.createQualifiedName(['Game', 'Main'])),
        [],
  ...
  describe('Complex Multi-Module Scenarios', () => {
    it('should handle three-module dependency chain', () => {
      ...
      const utilsModule = factory.createProgram(
        ...
        [],
        [],
        [factory.createFunctionDeclaration('helper', [], factory.createPrimitiveType('void'), [], true, false)]
      )
      ...
      const engineModule = factory.createProgram(
        ...
        [],
        [factory.createFunctionDeclaration('process', [], factory.createPrimitiveType('void'), [], true, false)]
      )
    ...
    it('should handle multiple imports from same module', () => {
      const utilsModule = factory.createProgram(
        ...
        [],
        [
          factory.createFunctionDeclaration('helper1', [], factory.createPrimitiveType('void'), [], true, false),
          factory.createFunctionDeclaration('helper2', [], factory.createPrimitiveType('byte'), [], true, false)
        ]
      )
  ...
  describe('Error Reporting Quality', () => {
    it('should provide helpful suggestions for missing imports', () => {
      const moduleA = factory.createProgram(
        ...
        [],
        [],
        [factory.createFunctionDeclaration('correctFunction', [], factory.createPrimitiveType('void'), [], false, true)]
      )
