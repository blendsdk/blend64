    ...
    try {
      ...
      switch (optimizationType) {
        ...
        case 'io_variable_declaration':
          ...
          const apiConstant = declRegisterAddress === 0xD01E ? 'VIC_SPRITE_COLLISION_REG' : 'VIC_BACKGROUND_COLLISION_REG';
        ...
        case 'io_variable_access':
          ...
          const apiFunction = registerAddress === 0xD01E ? 'readVICSpriteCollisions' : 'readVICBackgroundCollisions';
        ...
        case 'direct_memory_access':
          ...
          const optimizedFunction = address === 0xD01E ? 'readVICSpriteCollisions' : 'readVICBackgroundCollisions';
