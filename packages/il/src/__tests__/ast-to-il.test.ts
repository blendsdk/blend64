...
function createMockSymbolTable(): Map<string, Symbol> {
...
function createMockLiteral(value: number | boolean | string): Literal {
  return {
    type: 'Literal',
    value,
    raw: String(value)
...
function createMockBinaryExpr(operator: string, left: any, right: any): BinaryExpr {
  return {
    type: 'BinaryExpr',
    operator,
    left,
...
describe('Program Transformation', () => {
  let symbolTable: Map<string, Symbol>;
  let transformer: ASTToILTransformer;
...
describe('Function Declaration Transformation', () => {
  ...
  it('should transform function with parameters', () => {
    ...
    const paramSymbol: FunctionSymbol = {
      name: 'funcWithParams',
      symbolType: 'Function',
      sourceLocation: { line: 1, column: 1, offset: 0 },
      scope: {
  ...
  it('should transform callback functions', () => {
    ...
    const callbackSymbol: FunctionSymbol = {
      name: 'onInterrupt',
      symbolType: 'Function',
      sourceLocation: { line: 1, column: 1, offset: 0 },
      scope: {
...
describe('Control Flow Transformation', () => {
  ...
  it('should generate proper labels for control flow', () => {
    ...
    const nestedIfStmt: IfStatement = {
      type: 'IfStatement',
    ...
    const labelNames = labelInstructions.map(instr => (instr.operands[0] as any).name);
  ...
  it('should handle break and continue statements', () => {
    ...
    const whileWithBreak: WhileStatement = {
      type: 'WhileStatement',
      condition: createMockLiteral(true),
      body: [
        {
...
describe('Optimization Metadata Integration', () => {
  ...
  it('should integrate variable optimization metadata', () => {
    ...
    const optimizedVarSymbol: VariableSymbol = {
      name: 'hotVar',
      symbolType: 'Variable',
      sourceLocation: { line: 1, column: 1, offset: 0 },
      scope: {
...
describe('IL Transformation Integration', () => {
  ...
  it('should transform simple program with variable and function', () => {
    ...
    const globalVarSymbol: VariableSymbol = {
      name: 'globalCounter',
      symbolType: 'Variable',
      sourceLocation: { line: 1, column: 1, offset: 0 },
      scope: {
    ...
    const mainFunc: FunctionDeclaration = {
      type: 'FunctionDeclaration',
      name: 'main',
      params: [],
      returnType: { type: 'PrimitiveType', name: 'void' },
    ...
    const mainFuncSymbol: FunctionSymbol = {
      name: 'main',
      symbolType: 'Function',
  ...
  it('should maintain instruction ordering and dependencies', () => {
    ...
    const complexExpr = createMockBinaryExpr(
      '+',
      createMockBinaryExpr('*', createMockLiteral(2), createMockLiteral(3)),
      createMockBinaryExpr('/', createMockLiteral(10), createMockLiteral(2))
    );
  ...
  it('should generate proper temporary variable IDs', () => {
    ...
    const funcDecl: FunctionDeclaration = {
      ...
      body: [
        {
          type: 'ExpressionStatement',
          expression: createMockBinaryExpr(
            '*',
