...
const byteType: Blend65Type = { kind: 'primitive', name: 'byte' };

describe('IL Builder System Integration Tests', () => {
  let context: ILBuilderContext;
  let programBuilder: ILProgramBuilder;
  let moduleBuilder: ILModuleBuilder;
  let functionBuilder: ILFunctionBuilder;
