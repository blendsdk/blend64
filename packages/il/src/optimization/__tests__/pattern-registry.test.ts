...
describe('OptimizationPatternRegistry', () => {
  let registry: OptimizationPatternRegistryImpl;
  let testPattern: OptimizationPattern;
  ...
  beforeEach(() => {
    ...
    testPattern = {
      ...
      dependencies: [],
      conflicts: [],
      apply: (instructions: ILInstruction[], context: any) => ({
        success: true,
        metricsChange: {
          cyclesDelta: -3,
          sizeDelta: -2,
  ...
  describe('Level-Based Retrieval', () => {
    ...
    it('should handle invalid optimization levels', () => {
      ...
      const invalidLevel = 'INVALID' as OptimizationLevel;
  ...
  describe('Pattern Validation', () => {
    it('should validate pattern structure on registration', () => {
      ...
      delete (incompletePattern as any).id;

      // Registry itself doesn't validate - that's handled by PatternBuilder
      expect(() => registry.register(incompletePattern as any)).not.toThrow();
    });
...
describe('PatternBuilder', () => {
  ...
  let testRegistry: OptimizationPatternRegistryImpl;
  let builderTestPattern: OptimizationPattern;
  ...
  describe('Pattern Functionality', () => {
    it('should create patterns with working apply functions', () => {
      ...
      const result = workingPattern.apply([], {} as any);
    ...
    it('should create patterns with working applicability tests', () => {
      ...
      const isApplicable = testablePattern.isApplicable([{} as any], {} as any);
  ...
  describe('Built-in Pattern Behavior', () => {
    it('should have functional NOP elimination pattern', () => {
      ...
      const nopPattern = deadCodePatterns.find((p: OptimizationPattern) => p.id.includes('nop'));
      ...
      // Test application
      const result = nopPattern!.apply(instructionsWithNop, {} as any);
      expect(result.success).toBe(true);
