...
| Task 2.1.1 | Phase 2.1 | Enumerate ordering/structure diagnostics and add codes/messages to `ParserDiagnosticCode`. | Task 1.3 | Updated enum + why-focused doc comments. | [ ] |
| Task 2.1.2 | Phase 2.1 | Add vitest coverage validating diagnostic messages/severity for new codes. | Task 2.1.1 | Snapshot or explicit string tests. | [ ] |
