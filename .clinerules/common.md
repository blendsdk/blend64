...
3. $gitcm is alias for: stating all changes, creating a detailed commit
4. $gitcmp is alias for $gitcm and then `git rebase` then if there is not conflict then `git push`
